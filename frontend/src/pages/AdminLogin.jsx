  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-24" data-testid="admin-login-page">
      <form onSubmit={submit} className="w-full max-w-md rounded-3xl border border-[#E2E8F0] bg-white p-10 shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
        <div className="w-12 h-12 rounded-xl bg-[#1A365D] text-white flex items-center justify-center mb-6"><Lock className="w-5 h-5" /></div>
        <h1 className="serif text-3xl text-[#1A365D]">Admin sign-in</h1>
        ...
        <div className="mt-8 space-y-4">
          <div>
            ...
            <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" required data-testid="admin-email-input"
              className="w-full rounded-xl border border-[#E2E8F0] px-4 py-3 text-sm focus:border-[#00B4D8] focus:outline-none focus:ring-2 focus:ring-[#00B4D8]/20" />
          </div>
          <div>
        ...
        <button
          ...
          className="btn-shine mt-8 w-full rounded-full bg-[#1A365D] text-white py-3 text-sm font-semibold hover:bg-[#132a4a] active:scale-95 disabled:opacity-60"
        >
