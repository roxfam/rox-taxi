...
export default function Contact() {
  ...
  return (
    <div data-testid="contact-page" className="max-w-5xl mx-auto px-6 lg:px-10 py-24">
      ...
      <h1 className="serif text-6xl sm:text-7xl text-[#0B3B5C] mt-3 leading-[0.9]">Say <em className="italic text-[#D4A94A]">hello</em>.</h1>
      ...
      <div className="mt-12 grid sm:grid-cols-2 gap-5">
        ...
        <a href="tel:+12420000000" data-testid="contact-phone" className="rounded-2xl border border-[#E2E8F0] bg-white p-6 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(212,169,74,0.12)] transition-transform">
        ...
        <a href="mailto:hello@roxtaxi.com" data-testid="contact-email" className="rounded-2xl border border-[#E2E8F0] bg-white p-6 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(212,169,74,0.12)] transition-transform">
