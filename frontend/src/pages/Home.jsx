...
import { ArrowRight, Car, MapPinned, ShipWheel, Star, ShieldCheck, Clock } from "lucide-react";
      ...
      <section className="relative min-h-[92vh] overflow-hidden" data-testid="hero-section">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10 pt-32 pb-24 grid lg:grid-cols-12 gap-10">
          ...
          >
            ...
            <h1 className="serif text-5xl sm:text-6xl lg:text-7xl leading-[0.95] tracking-tight">
              Rides & <em className="italic text-[#FFD8B1]">reef days</em>,<br />across the Bahamas.
            </h1>
            <p className="mt-6 max-w-xl text-lg text-white/85 leading-relaxed">
              Pre-book taxis, unforgettable island excursions and car rentals — pay online with card, PayPal or Zelle.
              Track your driver from confirmation to arrival.
            </p>
          ...
          >
            <div className="glass rounded-3xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.15)]">
              ...
              <div className="grid grid-cols-1 gap-3">
                <Link
                  to="/taxi"
                  data-testid="quickbook-taxi"
                  className="flex items-center justify-between rounded-2xl border border-[#E2E8F0] bg-white p-4 hover:border-[#00B4D8] hover:-translate-y-0.5 transition-transform"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#64748B]">from $35 per trip</div>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#64748B]">Economy to Luxury · from $55/day</div>
                    </div>
                  </div>
                  <ArrowRight className="w-5 h-5 text-[#1A365D]" />
                </Link>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-24" data-testid="featured-tours">
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <h2 className="serif text-4xl sm:text-5xl tracking-tight text-[#1A365D] mt-2">Signature excursions</h2>
          </div>
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-2 flex items-center justify-between text-sm">
                  ...
                  <span className="mono font-semibold text-[#FF7F50]">{money(t.price)}</span>
                </div>
                <Link
                  to={`/tours?book=${t.id}`}
      ...
      <section className="bg-[#0B192C] text-white py-24" data-testid="how-it-works">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid md:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h2 className="serif text-4xl sm:text-5xl mt-3">Book · Pay · Track · Ride.</h2>
            <p className="mt-5 text-white/70 max-w-lg leading-relaxed">
              Everything runs from your browser — no app to download. Reserve online, get an instant confirmation
              code, then watch your booking status update in real time.
            </p>
          </div>
