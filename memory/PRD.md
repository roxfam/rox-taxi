...
- **[Feb 2026]** **Full-size sedan refresh** — `malibu-fullsize` updated to **2024 Chevrolet Malibu (Summit White)** using the user's uploaded photo. Model year bumped 2019 → 2024 in both `seed_data.py` (future re-seeds) and the live `db.rentals` document. Rentals page now has three uniformly crisp white-car cards (Spark / Malibu / Trax).
