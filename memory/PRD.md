...
- **[Feb 2026]** **Carousel imagery pass** — Atlantis Paradise Island (card 1) + Junkanoo Beach (card 5) swapped to user-uploaded photos alongside the previously updated Straw Market shot. 3 of 7 slides now use branded assets vs. Pexels placeholders.
