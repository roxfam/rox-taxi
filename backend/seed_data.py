...
TAXI_SERVICES: List[Dict] = [
    ...
    {"id": "downtown-lyford", "name": "Downtown Nassau → Lyford Cay (one-way)", "price": 60.0,
     ...
     "image_url": _TAXI_IMG},
    # ── Beach-run per-person fares (added Feb 12) ──────────────────────
    # Priced per passenger so families/groups see honest math. Booking
    # flow multiplies the fare by pax count and honours round-trip toggle
    # (10% off both legs) exactly like the flat-fare routes.
    {"id": "port-love-beach", "name": "Downtown / Cruise Port → Love Beach", "price": 20.0,
